...
const paginatedResults = () => {
    ...
    return (req: { searchResult: any; body: { page: string; limit: string; }; },res: { send: (arg0: { posts: { posts: any; }; }) => void; },next: () => void) => {
...
postsRouter.post('/all',searchResults(posts), paginatedResults(posts),(req:Request,res:Response)=>{
